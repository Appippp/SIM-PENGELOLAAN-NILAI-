...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 fw-bold">TAMBAH DATA MATA PELAJARAN</h1>
    </div>
            ...
            <div class="card">
                <div class="card-header bg-info">
                    <div class="card-title">
                        <h5 style="font-family: Verdana, Geneva, Tahoma, sans-serif" class="text-white">FORM TAMBAH DATA MATA
                            PELAJARAN
                        </h5>
                    </div>
                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="number" name="kkm" class="form-control @error('kkm') is-invalid @enderror"
                                    placeholder="MASUKKAN KKM" value="{{ old('kkm') }}">
                                @error('kkm')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
